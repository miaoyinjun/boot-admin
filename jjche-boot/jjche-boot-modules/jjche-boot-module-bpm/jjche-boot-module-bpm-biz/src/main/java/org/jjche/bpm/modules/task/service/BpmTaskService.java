...
public class BpmTaskService extends MyServiceImpl<BpmTaskExtMapper, BpmTaskExtDO> {
    ...
    public MyPage<BpmTaskTodoPageItemRespVO> getTodoTaskPage(Long userId, BpmTaskTodoPageReqVO pageVO) {
        ...
        List<UserVO> users = sysBaseApi.listUserByIds(startUserIds);
    ...
    public List<BpmTaskRespVO> getTaskListByProcessInstanceId(String processInstanceId) {
        ...
        List<UserVO> users = sysBaseApi.listUserByIds(userIds);
        ...
        List<DeptSmallDTO> deptSmalls = sysBaseApi.listDeptSmallByIds(deptIds);
        // 拼接数据
    ...
    public void updateTaskExtAssign(Task task) {
        ...
        TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronization() {
            ...
            public void afterCommit() {
                ...
                UserVO startUser = sysBaseApi.getUserById(Long.valueOf(processInstance.getStartUserId()));
