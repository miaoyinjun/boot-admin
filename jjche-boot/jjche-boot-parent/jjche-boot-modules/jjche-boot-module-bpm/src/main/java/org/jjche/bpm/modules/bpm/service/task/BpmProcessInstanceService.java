package org.jjche.bpm.modules.bpm.service.task;
...
import org.jjche.bpm.modules.bpm.api.dto.BpmProcessInstanceCreateReqDTO;
...
public interface BpmProcessInstanceService {
    ...
    default Map<String, ProcessInstance> getProcessInstanceMap(Set<String> ids) {
        Map<String, ProcessInstance> map = MapUtil.empty();
    ...
    default Map<String, HistoricProcessInstance> getHistoricProcessInstanceMap(Set<String> ids) {
        Map<String, HistoricProcessInstance> map = MapUtil.empty();
