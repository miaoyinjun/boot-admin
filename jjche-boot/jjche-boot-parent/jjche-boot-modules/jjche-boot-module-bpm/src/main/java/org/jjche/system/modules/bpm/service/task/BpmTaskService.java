...
public interface BpmTaskService {
     ...
     * @return 流程任务分页
     */
    MyPage<BpmTaskTodoPageItemRespVO> getTodoTaskPage(Long userId, BpmTaskTodoPageReqVO pageReqVO);
     ...
     * @return 流程任务分页
     */
    MyPage<BpmTaskDonePageItemRespVO> getDoneTaskPage(Long userId, BpmTaskDonePageReqVO pageReqVO);
