...
public class UserController extends BaseController implements UserApi {
    ...
    public List<UserVO> listByIds(@RequestParam Set<Long> ids) {
        return this.userService.listByIds(ids);
    }

    @Override
    @GetMapping("list-by-dept-ids")
    public List<UserVO> listByDeptIds(@RequestParam Set<Long> deptIds) {
        return this.userService.listByDeptIds(deptIds);
    }
}
