...
public class SecurityCommonAppKeyController extends BaseController implements SecurityCommonAppKeyApi {

    private final SecurityCommonAppKeyService securityAppKeyService;
